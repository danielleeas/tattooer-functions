...
import ManualBookingRequest from "./manual-booking-request.tsx";
...
Deno.serve(async (req)=>{
  try {
    ...
    const { to, email_templates, avatar_url, variables, payment_links } = payload || {};
    ...
    const html = await render(React.createElement(ManualBookingRequest, {
      email_templates,
      avatar_url,
      variables,
      payment_links
